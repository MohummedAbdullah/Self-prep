  ...
  technicalTerms: [
    {
      ...
      definition: 'Next.js feature that updates static pages after deployment without full rebuild, by revalidating in background.',
      category: 'Rendering',
      importance: 'high',
    },
    {
      term: 'HOC (Higher-Order Component)',
      definition: 'A function that takes a component and returns an enhanced component. Used for code reuse, logic abstraction.',
      category: 'Patterns',
      importance: 'high',
    },
    ...
    {
      term: 'Arrow Function',
      definition: 'ES6 concise function syntax with lexical this binding. Cannot be used as constructors or have arguments object.',
      category: 'JavaScript',
      importance: 'high',
    },
    {
      term: 'Normal Function',
      definition: 'Traditional function declaration/expression with own this binding. Can be used as constructors with new keyword.',
      category: 'JavaScript',
      importance: 'high',
    },
    {
      term: 'useContext',
      definition: 'Hook that consumes context values from nearest Context.Provider, triggering re-renders on context changes.',
      category: 'Hooks',
      importance: 'high',
    },
    {
    ...
    },
    {
      ...
      definition: 'Hook that subscribes to external stores (Redux, Zustand) with concurrency safety. Required for concurrent rendering.',
      category: 'Hooks',
      importance: 'medium',
    },
    {
    ...
    },
    {
      ...
      definition: 'Delays updating a value to keep UI responsive during expensive renders. Returns deferred version that may lag behind.',
      category: 'Concurrent',
      importance: 'medium',
    },
    {
      term: 'useId',
      definition: 'Hook that generates stable unique IDs for accessibility attributes (aria-describedby) across server/client.',
      category: 'Hooks',
      importance: 'medium',
    },
    {
    ...
    {
      term: 'useOptimistic',
      definition: 'Hook that allows optimistic UI updates - shows expected result immediately while async operation completes.',
      category: 'Hooks',
      importance: 'medium',
    },
    {
    ...
    },
    {
      ...
      definition: 'Synchronous hook that runs before DOM mutations, specifically for CSS-in-JS libraries to inject styles.',
      category: 'Hooks',
      importance: 'low',
    },
  ] as TechnicalTerm[],
...
useEffect(() => {
  ...
  questions: [

    {
      ...
      answer: 'useInsertionEffect runs synchronously before DOM mutations, specifically for CSS-in-JS libraries. It injects styles before layout effect runs, preventing FOUC (Flash of Unstyled Content). Rarely used in app code; primarily for library authors (styled-components, Emotion).',
      difficulty: 'hard',
    },
    {
      question: 'How does useOptimistic work and when would you use it?',
      answer: 'useOptimistic allows optimistic UI updates - shows expected result immediately while async operation completes. Takes current state and update function. Returns optimistic state and function to trigger update. Used for likes, comments, form submissions where you want instant feedback before server confirms.',
      difficulty: 'hard',
    },
    {
      question: 'What problem does useSyncExternalStore solve and when would you use it?',
      answer: 'useSyncExternalStore subscribes to external stores with concurrency safety. Required for React 18 concurrent rendering to avoid tearing (inconsistent UI). Used by Redux, Zustand, and other external state libraries. Prefer over useSubscription for external non-React state.',
      difficulty: 'hard',
    },
    {
      question: 'What is the difference between useDeferredValue and useTransition?',
      answer: 'useDeferredValue defers a specific value (like search input). useTransition wraps state update in startTransition. useDeferredValue for values from outside (props, external stores). useTransition for state updates inside component. Both keep UI responsive but different APIs.',
      difficulty: 'hard',
    },
    {
    ...
    {
      question: 'When would you use an arrow function vs a normal function in a React component?',
      answer: 'Use arrow functions for: event handlers (auto-binding this), callbacks, array methods, preserving this in nested functions. Use normal functions for: methods that need prototype sharing, constructors, dynamic this binding, or when you need arguments object. Arrow functions are preferred for inline handlers.',
      difficulty: 'medium',
    },
    {
      question: 'What is ISR (Incremental Static Regeneration) and how does it differ from traditional SSG?',
      answer: 'ISR allows static pages to be updated after deployment without full rebuild. Pages are regenerated in background when revalidation time expires. Unlike traditional SSG (build-time only), ISR serves stale data while regenerating, enabling fresh content without rebuilding entire site.',
      difficulty: 'medium',
    },
    {
      question: 'What is a Higher-Order Component (HOC) and provide an example use case?',
      answer: 'HOC is a function that takes a component and returns an enhanced component. Used for cross-cutting concerns like authentication, logging, or data fetching. Example: withAuth(Component) that checks user auth before rendering protected component.',
      difficulty: 'medium',
    },
    {
      question: 'What is the difference between a Higher-Order Component (HOC) and a Higher-Order Function (HOF)?',
      answer: 'HOC specifically works with React components (takes component, returns component). HOF is general JavaScript function that takes/returns functions (map, filter, debounce). HOCs are a specialized application of HOFs in React context.',
      difficulty: 'medium',
    },
    {
      question: 'When would you use useId instead of Math.random() or custom ID generators?',
      answer: 'useId generates stable unique IDs that are consistent between server and client, preventing hydration mismatches. Use for accessibility (aria-labelledby, htmlFor). Unlike Math.random(), useId works with SSR and avoids ID mismatches during hydration.',
      difficulty: 'medium',
    },
    {
      question: 'How does useContext work and what are its performance implications?',
      answer: 'useContext consumes value from nearest Context.Provider. Triggers re-renders on ALL consumers when context value changes, regardless of memoization. Split contexts by usage patterns to avoid unnecessary re-renders. Not optimized for frequent updates; consider state management for dynamic data.',
      difficulty: 'medium',
    },
    {
    ...
    {
      question: 'What are the differences between arrow functions and normal functions in React?',
      answer: 'Arrow functions: lexical this binding (inherits from parent scope), cannot be constructors, no arguments object, concise syntax. Normal functions: own this binding (depends on call), can be constructors with new, have arguments object. In React, arrow functions preserve this in event handlers automatically.',
      difficulty: 'easy',
    },
    {
